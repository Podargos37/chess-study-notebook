...
## Key Features
+ Auto-Save: Notes are automatically saved to the server ('storage.json') 1 second after text input.
...
## 주요 기능
+ 자동 저장: 텍스트 입력 후 1초 뒤 서버('storage.json')에 자동 저장됩니다.
+ 화살표와 칸 강조: 우클릭 드래그로 화살표를, 우클릭으로 칸 강조를 할 수 있지만 저장되지는 않습니다.
